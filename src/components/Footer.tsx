...
const FEATURES = [
  {
    ...
    desc: "보증365는 실시간 빅데이터 분석으로 거래내역, 리뷰, 정산 패턴을 종합 점검합니다. 위험 사이트는 즉시 차단, 안전한 곳만 추천합니다.",
  ...
  },
  {
    ...
    desc: "모든 제휴업체는 최대1억원 보증금을 실제 예치해야 등록 가능! 만약 문제가 생기면 보증365가 직접 보상합니다. \"실제 보상 가능한 검증업체, 보증365\"",
